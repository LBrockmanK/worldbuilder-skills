...
Baron of Mistria, now serving as Advisor to the King in the Capital. An administrator who earned his title through Crown service, not inheritance. Father of Adeline and Eiland, husband of Linnet. He built Mistria's systems and left them in his daughter's hands when the Crown called him away. He watches from a distance, writes letters he edits down to nothing, and keeps a rainy-day drink tradition alive through the friends who stayed.
...
- **Landen -- Community Thread:** They built the axe THUNDERSTRUCK from a lightning-struck tree and each claims credit for different parts. Landen helped renovate the Manor alongside Errol. The friendship runs through shared work, not shared words.

## Voice / Dialogue

### Casual / social -- Writing a letter at the Capital

*Wiscar sits at a desk. A cape hangs over the back of his chair. He writes, pauses, scratches out a line.*

"Linnet, remind me not to comment on the foundation work. She does not need my notes."

*He writes another line, reads it back, and scratches that out too.*

"I was about to say the same thing I said last week. She'll notice."

*He folds the letter with one note left in it: asking after the Inn's rainy-day stock.*

*Exercises: checks on things from a distance (Soul), cape habit (Body), values presence / cost of distance (Soul), drink tradition (Background).*

### Authority / power dynamic -- Addressing a gathering

*Wiscar steps forward. His posture is formal. His voice carries without effort.*
...
*A pause. He notices someone's collar is crooked and does not mention it. Yet.*

"It's clear how hard you've worked. I'm so proud of you all!"

*Exercises: formality as measuring tool then dropped (Soul), noticing dress (Body), pride in others' work (Soul), administrator's eye (Background).*
...
- Wiscar is a cameo NPC with no dedicated character data in the game. Built from 26 scattered references across other characters' profiles and 37 lines of game dialogue.
- User direction: administrator background (not craftsman), source of Adeline's organizational behavior.
- User direction: born into lesser nobility, elevated to landed Baron. Dropped "lesser nobility" detail from final card as it did not add enough.
- Linnet flagged as former adventurer (to be built in her own card); source material strongly supports this (Summit rescue, "Lady Linnet's sword" gossip, Shield of the Realm award).
- Physical appearance drawn from portrait sprite reference (no text description exists in source material).
- Soul entries are the largest extrapolation. Source material has zero internal states for Wiscar; all psychology inferred from behavioral patterns across other characters' references.
- Voice/Dialogue incorporates actual game lines from mistril_rank.c.toml and wedding speeches.
- Intimate Dynamics skipped: not dateable, no project-plan flag for cameo characters.

### Builder Context

- Cameo-tier character elevated to supporting character for card purposes. He has enough relationship density and narrative function to justify it.
- His narrative function is the absent steward: the man who built the systems Adeline runs, watching from a distance.
- The "fourteen notes" pattern (opinions he does not voice) is invented but consistent with his administrator psychology and his trust-but-check Soul entries.
- Wedding speech differentiation (Adeline gets stewardship affirmation, Eiland gets personal growth nudge) is directly from game data and is the strongest evidence for how he sees each child differently.
- Story notes pending: no standalone story arcs identified yet. His narrative is distributed across his children's arcs.
