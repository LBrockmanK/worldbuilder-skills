...
- **Renames:** never rename a vault document by hand — use `rename_doc.py`, which renames the file, updates the title, and rewrites inbound links (body paths and frontmatter wikilinks). Regenerate the directory index afterwards.
